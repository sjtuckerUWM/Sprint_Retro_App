<template>
  <div
    class="max-w-md mx-auto pt-4 bg-red rounded-xl shadow-md overflow-hidden md:max-w-2xl"
  >
    <div class="p-8">
      <div class="tracking-wide text-md font-semibold">Enter Feedback:</div>
      <div class="flex">
        <button
          id="states-button"
        ...
        <input class="border-2 w-3/5 rounded-lg mr-2" />
      </div>
    </div>
  </div>
</template>
